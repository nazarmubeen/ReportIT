...
<html>
  <head>
    ...
    <title>My JSP 'Workschedules.jsp' starting page</title>
        ...
        <div id="templatemo_content">
        	<div id="templatemo_left_content">
           	  <div class="templatemo_menu">
               	  <ul>
					  <li><a href="User.jsp" target="_parent" class="current">Home</a></li>
					  <li><a href="Complaint_Status.jsp" target="_parent">Check  Complaint status </a></li>
				      <li><a href="Insert_Complaints.jsp" target="_parent">Insert Complaints </a></li>	
				      <li><a href="Edit_Profile.jsp">Edit Profile </a></li>
					   <li><a href="Workschedules.jsp">Check Your Workschedules </a></li>
			      </ul>
              </div>
