        ...
        <div id="templatemo_content">
        	<div id="templatemo_left_content">
           	  <div class="templatemo_menu">
               	  <ul>
					  <li><a href="Home.jsp" target="_parent" class="current">Home</a></li>
					  <li><a href="Check_Complaints.jsp" target="_parent">Check Complaints </a></li>
				      <li><a href="Check_User.jsp" target="_parent">Check users </a></li>	
				      <li><a href="Check_Engineers.jsp">Check Engineers</a></li>
					   <li><a href="Check_Workschedules.jsp">Check Workschedules </a></li>
			      </ul>
              </div>
